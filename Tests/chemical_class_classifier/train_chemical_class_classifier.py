...
--------------
  ...
  python TiltedVAEMyzus/Tests/chemical_class_classifier/train_chemical_class_classifier.py --embeddings TiltedVAEMyzus/Tests/chemical_class_classifier/embeddings.pt --metadata METADATA/synthesisprogram_compoundno.csv --save_predictions --label_col synthesis_program --min_compounds_per_class 30
