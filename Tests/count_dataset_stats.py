...
def main() -> None:
    ...
    print(f"Selected compounds   : {len(selected_compounds)}")
    print(f"Found in metadata    : {sel_found}")
    print(f"Missing in metadata  : {sel_missing}")
    ...
    print(f"Unique compounds     : {len(ppm500_compounds)}")
    print(f"Found in metadata    : {ppm_found}")
    print(f"Missing in metadata  : {ppm_missing}")
